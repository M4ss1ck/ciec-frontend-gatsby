...
const IndexPage = ({ data }) => (
  <>
    ...
    <article className="container m-auto justify-content-between float text-justify ">
      <h2 className="titulo">
      ...
      <div className="columns-1 md:columns-2 lg:columns-3">
        ...
        <p>
          ...
          constituye uno de los núcleos principales para el desarrollo del
          turismo en nuestro país debido a la gran belleza de muchos de sus
          recursos naturales, entre los que sobresalen, sus bosques, manglares,
          playas y su rica biodiversidad.
        </p>
        <p>
          Dado el creciente desarrollo del turismo en el territorio y la
          necesidad de proteger y utilizar de manera sostenible los recursos
          naturales del archipiélago, se funda nuestro centro el 28 de noviembre
          de 1991 en el sitio conocido por Playa Larga, donde actualmente se
          localiza la mayor cantidad de instalaciones turísticas de la zona.{" "}
        </p>
        {/* <p>
    ...
    <article>
      <h2 className="titulo mt-6">Noticias</h2>
        ...
        {data.allStrapiArticle.edges.map(document => (
          ...
          >
            <li className="group-hover:border-primario rounded-lg flex flex-col justify-center items-center">
              ...
              />
              <p className="line-clamp-3">{document.node.description}</p>
            </li>
          </Link>
        ))}
      </ul>
